...
type Backend interface {
	...
	TxPool() *core.TxPool
	GetPublicBlockChainAPI() *ethapi.PublicBlockChainAPI
}
...
type Config struct {
	...
	TargetGasLimitCalculation         bool
	TxGasLimit                        uint64
	TxCountLimit                      uint64
	TxCommitNanoseconds               uint64
	EvmTimeoutNanoseconds             uint64
	CallTimeoutNanoseconds            uint64
	DisableGhostStateAttackProtection bool
}
