...
func (n *Node) startInProc(apis []rpc.API) error {
	...
	handler := rpc.NewServer(n.config.IsRPCDebugLogging())
...
func (n *Node) SetDebugLogging(enable bool) {
	...
	n.ipcHandler.SetDebugLogging(enable)
	n.httpHandler.SetDebugLogging(enable)
	n.wsHandler.SetDebugLogging(enable)
}
