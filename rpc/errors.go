...
type notSupportedMethodError struct{}
func (e *notSupportedMethodError) ErrorCode() int { return -32601 }
func (e *notSupportedMethodError) Error() string { return "Not supported method" }
