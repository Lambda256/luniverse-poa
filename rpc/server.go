...
func NewServer(rpcDebugLogging bool) *Server {
	server := &Server{
...
func (s *Server) SetDebugLogging(enable bool) {
	s.rpcDebugLogging = enable
}
...
func (s *Server) handle(ctx context.Context, codec ServerCodec, req *serverRequest) (interface{}, func()) {
	...
	if s.rpcDebugLogging {
		log.Info("::: RPC :::", "Name", req.callb.method.Name)
	}
	if req.callb.method.Name == "UnlockAccount" {
		return codec.CreateErrorResponse(&req.id, &notSupportedMethodError{}), nil
	}
