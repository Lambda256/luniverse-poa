...
func (b *EthAPIBackend) GetNonTxEVM(ctx context.Context, msg core.Message, state *state.StateDB, header *types.Header, vmConfig *vm.Config, balance *big.Int) (*vm.EVM, func() error, error) {
	state.SetBalance(msg.From(), balance /*math.MaxBig256*/)
	if msg.GasDelegator() != nil {
		state.SetBalance(*msg.GasDelegator(), balance /*math.MaxBig256*/)
	}
...
func (b *EthAPIBackend) GetEvmTimeoutNanoseconds() uint64 {
	return params.EvmTimeoutNanoseconds
}

func (b *EthAPIBackend) GetCallTimeoutNanoseconds() uint64 {
	return params.CallTimeoutNanoseconds
}
...
func (b *EthAPIBackend) GetPoolGasPrice() *big.Int {
	return b.eth.txPool.GasPrice()
}

func (b *EthAPIBackend) GetPoolTxGasLimit() uint64 {
...
func (b *EthAPIBackend) StateAtTransaction(ctx context.Context, block *types.Block, txIndex int, reexec uint64) (*common.ConsensusConfig, core.Message, vm.BlockContext, *state.StateDB, error) {
