...
// SetDebugLoggingRPC Control debug logging flag dynamically (RPC)
func (api *PrivateDebugAPI) SetDebugLoggingRPC(enable bool) {
	api.eth.node.SetDebugLogging(enable)
}
