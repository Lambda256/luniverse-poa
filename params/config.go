...
var (
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllCliqueProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, &CliqueConfig{Period: 0, Epoch: 30000, SnapshotInterval: 1024, BlockReward: false, DynamicBlockPeriod: false}, nil}
...
type CliqueConfig struct {
	...
	BlockReward bool `json:"blockReward"`	// Block-Reward feature
	DynamicBlockPeriod bool `json:"dynamicBlockPeriod"`	// Dynamic Block Period feature
}
