...
func (b *LesApiBackend) GetNonTxEVM(ctx context.Context, msg core.Message, state *state.StateDB, header *types.Header, vmConfig *vm.Config, balance *big.Int) (*vm.EVM, func() error, error) {
	if vmConfig == nil {
...
func (b *LesApiBackend) GetEvmTimeoutNanoseconds() uint64 {
	return params.EvmTimeoutNanoseconds
}

func (b *LesApiBackend) GetCallTimeoutNanoseconds() uint64 {
...
func (b *LesApiBackend) GetPoolGasPrice() *big.Int {
	return nil
}

func (b *LesApiBackend) GetPoolTxGasLimit() uint64 {
	return 0
}
...
func (b *LesApiBackend) StateAtTransaction(ctx context.Context, block *types.Block, txIndex int, reexec uint64) (*common.ConsensusConfig, core.Message, vm.BlockContext, *state.StateDB, error) {
