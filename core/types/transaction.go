...
func NewMessage(chainConfig *params.ChainConfig, from common.Address, to *common.Address, nonce uint64, amount *big.Int, gasLimit uint64, gasPrice, gasFeeCap, gasTipCap *big.Int, payload []byte, accessList AccessList, isFake bool) Message {
...
func (tx *Transaction) AsMessage(chainConfig *params.ChainConfig, s Signer, baseFee *big.Int) (Message, error) {
	data, gasDelegator := extractExtensionFields(tx.Data())
	msg := Message{
		nonce:        tx.Nonce(),
		gasLimit:     tx.Gas(),
